...
\begin{frame}
    \frametitle{Heatmaps Coherences around epicenter when flight direction is the same}
    \begin{minipage}[t]{0.45\linewidth}
        \centering
        \begin{figure}
            \centering
            \includegraphics[width=1.25\linewidth]{figures/simple_coherence_from_epicenter.png}
